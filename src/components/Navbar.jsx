...
const Navbar = () => {
    ...
    return (
        <nav
            className={`w-full fixed top-0 z-50 px-6 py-4 flex justify-between items-center text-white transition-all duration-300 ${isScrolled ? 'bg-black shadow-lg' : 'bg-transparent'
                }`}
        >
            {/* logo */}
            ...
            >
                <li className="hover:text-gray-300 cursor-pointer">Collections</li>
                <li className="hover:text-gray-300 cursor-pointer">New</li>
                <li className="hover:text-gray-300 cursor-pointer">Best Sellers</li>
                <li className="hover:text-gray-300 cursor-pointer">Earrings</li>
                <li className="hover:text-gray-300 cursor-pointer">Rings</li>
                <li className="hover:text-gray-300 cursor-pointer">Necklaces</li>
                <li className="hover:text-gray-300 cursor-pointer">Bracelets</li>
            </ul>
